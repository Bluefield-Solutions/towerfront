...
export const ENEMIES: Record<EnemyId, EnemyDef> = {
  ...
  flyer: {
    ...
    hp: 62, speed: 118, bounty: 13, leak: 2, radius: 16, armor: 0, slowResist: 0.2,
    flying: true,
    body: '#3ED9A4', trim: '#C7FFE9',
  },
  splitter: {
    id: 'splitter', name: 'Spalter',
    hp: 130, speed: 78, bounty: 16, leak: 2, radius: 22, armor: 1, slowResist: 0.15,
    split: { into: 'splitling', count: 2, hpFactor: 0.3 },
    body: '#E8873C', trim: '#FFD9A8',
  },
  splitling: {
    id: 'splitling', name: 'Span',
    hp: 40, speed: 148, bounty: 4, leak: 1, radius: 12, armor: 0, slowResist: 0,
