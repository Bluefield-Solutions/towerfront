...
export const MAP_SPIRALHAIN: GameMap = {
  ...
  lanes: [
    [
      { x: -80, y: 210, w: 56 }, { x: 210, y: 226, w: 54 }, { x: 520, y: 300, w: 48 },
      { x: 760, y: 430, w: 34 }, { x: 980, y: 470, w: 32 }, { x: 1280, y: 396, w: 46 },
      { x: 1560, y: 300, w: 52 }, { x: 1760, y: 430, w: 50 }, { x: 1740, y: 700, w: 44 },
      { x: 1460, y: 850, w: 36 }, { x: 1080, y: 880, w: 34 }, { x: 720, y: 830, w: 44 },
      { x: 470, y: 700, w: 50 }, { x: 430, y: 500, w: 52 }, { x: 620, y: 620, w: 46 },
      { x: 900, y: 700, w: 40 }, { x: 1130, y: 640, w: 38 },
    ],
  ],
  rough: [
...
export const MAP_ASCHESCHLUCHT: GameMap = {
  ...
  lanes: [
    [
      { x: -80, y: 200, w: 52 }, { x: 200, y: 240, w: 50 }, { x: 430, y: 380, w: 40 },
      { x: 560, y: 560, w: 32 },
      { x: 760, y: 690, w: 44 }, { x: 1060, y: 760, w: 50 }, { x: 1380, y: 720, w: 46 },
      { x: 1620, y: 560, w: 38 }, { x: 1700, y: 330, w: 46 }, { x: 1500, y: 180, w: 50 },
      { x: 1200, y: 200, w: 46 }, { x: 1010, y: 350, w: 40 }, { x: 1040, y: 540, w: 44 },
    ],
    [
      { x: -80, y: 880, w: 52 }, { x: 180, y: 850, w: 50 }, { x: 400, y: 720, w: 42 },
      { x: 560, y: 560, w: 32 },
      { x: 760, y: 690, w: 44 }, { x: 1060, y: 760, w: 50 }, { x: 1380, y: 720, w: 46 },
      { x: 1620, y: 560, w: 38 }, { x: 1700, y: 330, w: 46 }, { x: 1500, y: 180, w: 50 },
      { x: 1200, y: 200, w: 46 }, { x: 1010, y: 350, w: 40 }, { x: 1040, y: 540, w: 44 },
...
export const MAP_FROSTSPALTE: GameMap = {
  ...
  lanes: [
    [
      { x: -80, y: 300, w: 44 }, { x: 200, y: 300, w: 42 }, { x: 420, y: 420, w: 30 },
      { x: 560, y: 640, w: 30 }, { x: 800, y: 800, w: 38 }, { x: 1080, y: 810, w: 42 },
      { x: 1300, y: 690, w: 30 },
      { x: 1520, y: 520, w: 40 }, { x: 1560, y: 300, w: 44 }, { x: 1360, y: 190, w: 42 },
      { x: 1120, y: 260, w: 38 }, { x: 1060, y: 470, w: 40 },
    ],
    [
      { x: 700, y: -80, w: 44 }, { x: 720, y: 180, w: 40 }, { x: 900, y: 330, w: 32 },
      { x: 1080, y: 520, w: 30 }, { x: 1300, y: 690, w: 30 },
      { x: 1520, y: 520, w: 40 }, { x: 1560, y: 300, w: 44 }, { x: 1360, y: 190, w: 42 },
      { x: 1120, y: 260, w: 38 }, { x: 1060, y: 470, w: 40 },
    ],
  ],
