...
export const MAP_ASCHESCHLUCHT: GameMap = {
  ...
  lanes: [
    ...
    [
      ...
      { x: 1492, y: 508, w: 46 }, { x: 1640, y: 564, w: 50 }, { x: 1795, y: 577, w: 40 },
    ],
  ],
  rough: [
    ...
    { x: 1112, y: 812, r: 50 }, { x: 1068, y: 623, r: 45 }, { x: 520, y: 987, r: 42 },
    { x: 285, y: 368, r: 36 },
  ],
  pfadImBild: true,
  hint: { x: 220, y: 200 },
...
export const MAP_FROSTSPALTE: GameMap = {
  ...
  lanes: [
    [
      ...
      { x: 589, y: 405, w: 44 }, { x: 429, y: 407, w: 40 }, { x: 203, y: 348, w: 40 },
    ],
    [
      ...
      { x: 469, y: 406, w: 40 }, { x: 350, y: 398, w: 40 }, { x: 203, y: 348, w: 40 },
    ],
  ],
  rough: [
