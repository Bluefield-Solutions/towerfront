...
export const TOWERS: Record<TowerId, TowerDef> = {
  arrow: {
    ...
    branches: [
      ...
      },
      {
        ...
        levels: [
          { cost: 70, damage: 14, range: 300, cooldown: 0.27, pierce: 1 },
          { cost: 145, damage: 23, range: 319, cooldown: 0.20, pierce: 2 },
          { cost: 295, damage: 31, range: 326, cooldown: 0.17, pierce: 2 },
          { cost: 605, damage: 41, range: 333, cooldown: 0.15, pierce: 3 },
          { cost: 1240, damage: 56, range: 340, cooldown: 0.14, pierce: 3 },
        ],
      },
    ],
  },
  frost: {
    ...
    base: { cost: 80, damage: 6, range: 180, cooldown: 0.85, slow: 0.34, slowTime: 1.5 },
    branches: [
      {
        id: 'eternal', name: 'Ewiges Eis', color: '#7FE7E0',
        blurb: 'Weiter Umkreis, harte Bremse, kaum Schaden. Reine Kontrolle.',
        levels: [
          { cost: 90, damage: 11, range: 234, cooldown: 0.7, slow: 0.45, slowTime: 2.2 },
          { cost: 150, damage: 22, range: 300, cooldown: 0.58, slow: 0.65, slowTime: 3.4 },
          { cost: 310, damage: 35, range: 330, cooldown: 0.53, slow: 0.73, slowTime: 4.05 },
          { cost: 635, damage: 56, range: 363, cooldown: 0.49, slow: 0.74, slowTime: 4.82 },
          { cost: 1300, damage: 89, range: 399, cooldown: 0.45, slow: 0.74, slowTime: 5.74 },
        ],
      },
      {
